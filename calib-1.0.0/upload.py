...
oam_manager_local_file_path = "/home/user/projects/branches/master/pc805-mplane/gl805_oru-7.0.0/firmware/mp_sw/oru_oam/oam_manager"
oam_manager_remote_file_path = "/opt/o-ran/sw/sw-0/oru_oam/oam_manager.downloaded"
oam_manager_remote_file_path = "/tmp/oam_manager.downloaded"
...
def file_handle_command(shell):
    ...
    # OAM manager
    upload_file_to_remote(oam_manager_local_file_path,oam_manager_remote_file_path)
